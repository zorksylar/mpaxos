...
def build(bld):
    bld.stlib(source=bld.path.ant_glob("libmpaxos/rpc/*.c libmpaxos/*.c"), target="mpaxos", includes="libmpaxos include", use="APR APR-UTIL JSON PROTOBUF PTHREAD LEVELDB")
